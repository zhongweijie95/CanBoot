...
DECL_CTR("DECL_RS485_PIN " __stringify(CONFIG_RS485_PIN));
extern uint32_t rs485_gpio, rs485_gpio_high; // Generated by buildcommands.py

static struct gpio_out rs485;
#endif
...
USARTx_IRQHandler(void)
{
    ...
    if (sr & USART_ISR_TC) {
        USARTx->CR1 = CR1_FLAGS;
        USARTx->SR = (uint16_t)~USART_ISR_TC;
...
#if CONFIG_ENABLE_RS485
    rs485 = gpio_out_setup(rs485_gpio, rs485_gpio_high==1?0:1); 
#endif       
}
